      ...
      .col-lg-6.col-10.order-lg-first.order-sm-last(data-aos="fade-right")
        ...
        .bloque-texto-b.color-secundario.p-4
          .bloque-texto-b__texto
            i.fas.fa-quote-left
            p.mb-0 Coronel, Morris & Rob, en su libro <em>Bases de datos: diseño, implementación y administración</em>(2011), señalan que las bases de datos:
              br
    ...
    .row.justify-content-center.align-items-center.mb-5
      .col-lg-10(data-aos="zoom-in")
        .titulo-sexto.color-acento-contenido
          h5 Tabla 1
          br
          span Tabla de permisos en MySQL
    ...
    .row.justify-content-center.align-items-center.mb-5
      .col-lg-10(data-aos="flip-up")
        .titulo-sexto.color-acento-contenido
          h5 Tabla 2
          br
          span Roles de bases de datos NoSql MongoDB
        .tabla-a.color-acento-contenido.mb-5
          table
          ...
          .row
            .col-lg-6.mb-4-mb-lg-0
              .titulo-sexto.color-acento-contenido.cfc(data-aos="fade-left")
                ...
                p.mb-0
                  <b>ISSUER</b> para esta condición es necesario que los clientes presenten certificado x509. Si un cliente presenta un certificado que es válido, pero tiene un emisor diferente, el servidor rechaza la conexión.
            .col-lg-6
              .titulo-sexto.color-acento-contenido.cfc(data-aos="fade-left")
                h5.mb-3 Ejemplo 5
                p.mb-0
